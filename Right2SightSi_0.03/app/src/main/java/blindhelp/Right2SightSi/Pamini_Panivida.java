...
public class Pamini_Panivida extends CallHistory implements View.OnClickListener, TextToSpeech.OnInitListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mediaPlayer=MediaPlayer.create(this,R.raw.recieved_msg);
        mediaPlayer.start();
    ...
    protected String getSmsName() {
        Name = smsName.get(a_read);a_read++;
    ...
    protected String getSms() {
        b_read=a_read;
        b_read--;
        sms = smsTxt.get(b_read);
        if(sms == null){
            ReadNumber("This function is not fully suported for this phone brand");
        }
        return sms;
    }
    ...
    private void next() {
        mediaPlayer=MediaPlayer.create(this,R.raw.next_msg);
        mediaPlayer.start();
    }

    private void read() {
        mediaPlayer=MediaPlayer.create(this,R.raw.read_msg);
        mediaPlayer.start();
    }

    private void reply() {
        mediaPlayer=MediaPlayer.create(this,R.raw.reply);
        mediaPlayer.start();
    }
