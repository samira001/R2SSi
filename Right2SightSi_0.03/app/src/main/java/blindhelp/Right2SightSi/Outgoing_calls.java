...
public class Outgoing_calls extends CallHistory implements TextToSpeech.OnInitListener, View.OnClickListener{
    ...
    private void CheckOutgoingCalls() {
        Phnumber=outgoing.get(i);
    ...
    private void nextnum() {
        mediaPlayer=MediaPlayer.create(this,R.raw.next_number);
        mediaPlayer.start();
    }
    ...
    private void sms() {
        mediaPlayer=MediaPlayer.create(this,R.raw.send_msg);
        mediaPlayer.start();
    }
